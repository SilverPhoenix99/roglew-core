module GL_EXT_paletted_texture
  ...
  FUNCTIONS = {
    glColorTableEXT: [ :void, :uint, :uint, :int, :uint, :uint, :pointer ].freeze,
    glGetColorTableEXT: [ :void, :uint, :uint, :uint, :pointer ].freeze,
    glGetColorTableParameterfvEXT: [ :void, :uint, :uint, :pointer ].freeze,
    glGetColorTableParameterivEXT: [ :void, :uint, :uint, :pointer ].freeze
  }.freeze
end
