module GL_ARB_vertex_blend
  ...
  FUNCTIONS = {
    glVertexBlendARB: [ :void, :int ].freeze,
    glWeightbvARB: [ :void, :int, :pointer ].freeze,
    glWeightdvARB: [ :void, :int, :pointer ].freeze,
    glWeightfvARB: [ :void, :int, :pointer ].freeze,
    glWeightivARB: [ :void, :int, :pointer ].freeze,
    glWeightPointerARB: [ :void, :int, :uint, :int, :pointer ].freeze,
    glWeightsvARB: [ :void, :int, :pointer ].freeze,
    glWeightubvARB: [ :void, :int, :pointer ].freeze,
    glWeightuivARB: [ :void, :int, :pointer ].freeze,
    glWeightusvARB: [ :void, :int, :pointer ].freeze
  }.freeze
end
