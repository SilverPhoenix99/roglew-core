module GL_EXT_geometry_shader4
  ...
  FUNCTIONS = {
    glFramebufferTextureEXT: [ :void, :uint, :uint, :uint, :int ].freeze,
    glFramebufferTextureFaceEXT: [ :void, :uint, :uint, :uint, :int, :uint ].freeze,
    glProgramParameteriEXT: [ :void, :uint, :uint, :int ].freeze
  }.freeze
end
