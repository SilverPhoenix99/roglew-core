module GL_ATI_fragment_shader
  ...
  FUNCTIONS = {
    glAlphaFragmentOp1ATI: [ :void, :uint, :uint, :uint, :uint, :uint, :uint ].freeze,
    glAlphaFragmentOp2ATI: [ :void, :uint, :uint, :uint, :uint, :uint, :uint, :uint, :uint, :uint ].freeze,
    glAlphaFragmentOp3ATI: [ :void, :uint, :uint, :uint, :uint, :uint, :uint, :uint, :uint, :uint, :uint, :uint, :uint ].freeze,
    glBeginFragmentShaderATI: [ :void,  ].freeze,
    glBindFragmentShaderATI: [ :void, :uint ].freeze,
    glColorFragmentOp1ATI: [ :void, :uint, :uint, :uint, :uint, :uint, :uint, :uint ].freeze,
    glColorFragmentOp2ATI: [ :void, :uint, :uint, :uint, :uint, :uint, :uint, :uint, :uint, :uint, :uint ].freeze,
    glColorFragmentOp3ATI: [ :void, :uint, :uint, :uint, :uint, :uint, :uint, :uint, :uint, :uint, :uint, :uint, :uint, :uint ].freeze,
    glDeleteFragmentShaderATI: [ :void, :uint ].freeze,
    glEndFragmentShaderATI: [ :void,  ].freeze,
    glGenFragmentShadersATI: [ :uint, :uint ].freeze,
    glPassTexCoordATI: [ :void, :uint, :uint, :uint ].freeze,
    glSampleMapATI: [ :void, :uint, :uint, :uint ].freeze,
    glSetFragmentShaderConstantATI: [ :void, :uint, :pointer ].freeze
  }.freeze
end
