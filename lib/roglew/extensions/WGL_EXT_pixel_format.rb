module WGL_EXT_pixel_format
  ...
  FUNCTIONS = {
    wglChoosePixelFormatEXT: [ :bool, :pointer, :pointer, :pointer, :uint, :pointer, :pointer ].freeze,
    wglGetPixelFormatAttribfvEXT: [ :bool, :pointer, :int, :int, :uint, :pointer, :pointer ].freeze,
    wglGetPixelFormatAttribivEXT: [ :bool, :pointer, :int, :int, :uint, :pointer, :pointer ].freeze
  }.freeze
end