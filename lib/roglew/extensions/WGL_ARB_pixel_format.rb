module WGL_ARB_pixel_format
  ...
  FUNCTIONS = {
    wglChoosePixelFormatARB: [ :bool, :pointer, :pointer, :pointer, :uint, :pointer, :pointer ].freeze,
    wglGetPixelFormatAttribfvARB: [ :bool, :pointer, :int, :int, :uint, :pointer, :pointer ].freeze,
    wglGetPixelFormatAttribivARB: [ :bool, :pointer, :int, :int, :uint, :pointer, :pointer ].freeze
  }.freeze
end