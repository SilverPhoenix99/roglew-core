module GL_EXT_vertex_shader
  ...
  FUNCTIONS = {
    ...
    glBindLightParameterEXT: [ :uint, :uint, :uint ].freeze,
    glBindMaterialParameterEXT: [ :uint, :uint, :uint ].freeze,
    glBindParameterEXT: [ :uint, :uint ].freeze,
    glBindTexGenParameterEXT: [ :uint, :uint, :uint, :uint ].freeze,
    glBindTextureUnitParameterEXT: [ :uint, :uint, :uint ].freeze,
    glBindVertexShaderEXT: [ :void, :uint ].freeze,
    glDeleteVertexShaderEXT: [ :void, :uint ].freeze,
    glDisableVariantClientStateEXT: [ :void, :uint ].freeze,
    glEnableVariantClientStateEXT: [ :void, :uint ].freeze,
    glEndVertexShaderEXT: [ :void,  ].freeze,
    glExtractComponentEXT: [ :void, :uint, :uint, :uint ].freeze,
    glGenSymbolsEXT: [ :uint, :uint, :uint, :uint, :uint ].freeze,
    glGenVertexShadersEXT: [ :uint, :uint ].freeze,
    glGetInvariantBooleanvEXT: [ :void, :uint, :uint, :pointer ].freeze,
    glGetInvariantFloatvEXT: [ :void, :uint, :uint, :pointer ].freeze,
    glGetInvariantIntegervEXT: [ :void, :uint, :uint, :pointer ].freeze,
    glGetLocalConstantBooleanvEXT: [ :void, :uint, :uint, :pointer ].freeze,
    glGetLocalConstantFloatvEXT: [ :void, :uint, :uint, :pointer ].freeze,
    glGetLocalConstantIntegervEXT: [ :void, :uint, :uint, :pointer ].freeze,
    glGetVariantBooleanvEXT: [ :void, :uint, :uint, :pointer ].freeze,
    glGetVariantFloatvEXT: [ :void, :uint, :uint, :pointer ].freeze,
    glGetVariantIntegervEXT: [ :void, :uint, :uint, :pointer ].freeze,
    glGetVariantPointervEXT: [ :void, :uint, :uint, :pointer ].freeze,
    glInsertComponentEXT: [ :void, :uint, :uint, :uint ].freeze,
    glIsVariantEnabledEXT: [ :uchar, :uint, :uint ].freeze,
    glSetInvariantEXT: [ :void, :uint, :uint, :pointer ].freeze,
    glSetLocalConstantEXT: [ :void, :uint, :uint, :pointer ].freeze,
    glShaderOp1EXT: [ :void, :uint, :uint, :uint ].freeze,
    glShaderOp2EXT: [ :void, :uint, :uint, :uint, :uint ].freeze,
    glShaderOp3EXT: [ :void, :uint, :uint, :uint, :uint, :uint ].freeze,
    glSwizzleEXT: [ :void, :uint, :uint, :uint, :uint, :uint, :uint ].freeze,
    glVariantbvEXT: [ :void, :uint, :pointer ].freeze,
    glVariantdvEXT: [ :void, :uint, :pointer ].freeze,
    glVariantfvEXT: [ :void, :uint, :pointer ].freeze,
    glVariantivEXT: [ :void, :uint, :pointer ].freeze,
    glVariantPointerEXT: [ :void, :uint, :uint, :uint, :pointer ].freeze,
    glVariantsvEXT: [ :void, :uint, :pointer ].freeze,
    glVariantubvEXT: [ :void, :uint, :pointer ].freeze,
    glVariantuivEXT: [ :void, :uint, :pointer ].freeze,
    glVariantusvEXT: [ :void, :uint, :pointer ].freeze,
    glWriteMaskEXT: [ :void, :uint, :uint, :uint, :uint, :uint, :uint ].freeze
  }.freeze
end
