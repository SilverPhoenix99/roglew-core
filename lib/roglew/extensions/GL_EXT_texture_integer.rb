module GL_EXT_texture_integer
  ...
  FUNCTIONS = {
    glClearColorIiEXT: [ :void, :int, :int, :int, :int ].freeze,
    glClearColorIuiEXT: [ :void, :uint, :uint, :uint, :uint ].freeze,
    glGetTexParameterIivEXT: [ :void, :uint, :uint, :pointer ].freeze,
    glGetTexParameterIuivEXT: [ :void, :uint, :uint, :pointer ].freeze,
    glTexParameterIivEXT: [ :void, :uint, :uint, :pointer ].freeze,
    glTexParameterIuivEXT: [ :void, :uint, :uint, :pointer ].freeze
  }.freeze
end
