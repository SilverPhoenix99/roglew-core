module GL_NV_video_capture
  ...
  FUNCTIONS = {
    glBeginVideoCaptureNV: [ :void, :uint ].freeze,
    glBindVideoCaptureStreamBufferNV: [ :void, :uint, :uint, :uint, :int64 ].freeze,
    glBindVideoCaptureStreamTextureNV: [ :void, :uint, :uint, :uint, :uint, :uint ].freeze,
    glEndVideoCaptureNV: [ :void, :uint ].freeze,
    glGetVideoCaptureivNV: [ :void, :uint, :uint, :pointer ].freeze,
    glGetVideoCaptureStreamdvNV: [ :void, :uint, :uint, :uint, :pointer ].freeze,
    glGetVideoCaptureStreamfvNV: [ :void, :uint, :uint, :uint, :pointer ].freeze,
    glGetVideoCaptureStreamivNV: [ :void, :uint, :uint, :uint, :pointer ].freeze,
    glVideoCaptureNV: [ :uint, :uint, :pointer, :pointer ].freeze,
    glVideoCaptureStreamParameterdvNV: [ :void, :uint, :uint, :uint, :pointer ].freeze,
    glVideoCaptureStreamParameterfvNV: [ :void, :uint, :uint, :uint, :pointer ].freeze,
    glVideoCaptureStreamParameterivNV: [ :void, :uint, :uint, :uint, :pointer ].freeze
  }.freeze
end
