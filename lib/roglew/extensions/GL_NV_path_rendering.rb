module GL_NV_path_rendering
  ...
  FUNCTIONS = {
    glCopyPathNV: [ :void, :uint, :uint ].freeze,
    glCoverFillPathInstancedNV: [ :void, :int, :uint, :pointer, :uint, :uint, :uint, :pointer ].freeze,
    glCoverFillPathNV: [ :void, :uint, :uint ].freeze,
    glCoverStrokePathInstancedNV: [ :void, :int, :uint, :pointer, :uint, :uint, :uint, :pointer ].freeze,
    glCoverStrokePathNV: [ :void, :uint, :uint ].freeze,
    glDeletePathsNV: [ :void, :uint, :int ].freeze,
    glGenPathsNV: [ :uint, :int ].freeze,
    glGetPathColorGenfvNV: [ :void, :uint, :uint, :pointer ].freeze,
    glGetPathColorGenivNV: [ :void, :uint, :uint, :pointer ].freeze,
    glGetPathCommandsNV: [ :void, :uint, :pointer ].freeze,
    glGetPathCoordsNV: [ :void, :uint, :pointer ].freeze,
    glGetPathDashArrayNV: [ :void, :uint, :pointer ].freeze,
    glGetPathLengthNV: [ :float, :uint, :int, :int ].freeze,
    glGetPathMetricRangeNV: [ :void, :uint, :uint, :int, :int, :pointer ].freeze,
    glGetPathMetricsNV: [ :void, :uint, :int, :uint, :pointer, :uint, :int, :pointer ].freeze,
    glGetPathParameterfvNV: [ :void, :uint, :uint, :pointer ].freeze,
    glGetPathParameterivNV: [ :void, :uint, :uint, :pointer ].freeze,
    glGetPathSpacingNV: [ :void, :uint, :int, :uint, :pointer, :uint, :float, :float, :uint, :pointer ].freeze,
    glGetPathTexGenfvNV: [ :void, :uint, :uint, :pointer ].freeze,
    glGetPathTexGenivNV: [ :void, :uint, :uint, :pointer ].freeze,
    glInterpolatePathsNV: [ :void, :uint, :uint, :uint, :float ].freeze,
    glIsPathNV: [ :uchar, :uint ].freeze,
    glIsPointInFillPathNV: [ :uchar, :uint, :uint, :float, :float ].freeze,
    glIsPointInStrokePathNV: [ :uchar, :uint, :float, :float ].freeze,
    glPathColorGenNV: [ :void, :uint, :uint, :uint, :pointer ].freeze,
    glPathCommandsNV: [ :void, :uint, :int, :pointer, :int, :uint, :pointer ].freeze,
    glPathCoordsNV: [ :void, :uint, :int, :uint, :pointer ].freeze,
    glPathCoverDepthFuncNV: [ :void, :uint ].freeze,
    glPathDashArrayNV: [ :void, :uint, :int, :pointer ].freeze,
    glPathFogGenNV: [ :void, :uint ].freeze,
    glPathGlyphRangeNV: [ :void, :uint, :uint, :pointer, :uint, :uint, :int, :uint, :uint, :float ].freeze,
    glPathGlyphsNV: [ :void, :uint, :uint, :pointer, :uint, :int, :uint, :pointer, :uint, :uint, :float ].freeze,
    glPathParameterfNV: [ :void, :uint, :uint, :float ].freeze,
    glPathParameterfvNV: [ :void, :uint, :uint, :pointer ].freeze,
    glPathParameteriNV: [ :void, :uint, :uint, :int ].freeze,
    glPathParameterivNV: [ :void, :uint, :uint, :pointer ].freeze,
    glPathStencilDepthOffsetNV: [ :void, :float, :float ].freeze,
    glPathStencilFuncNV: [ :void, :uint, :int, :uint ].freeze,
    glPathStringNV: [ :void, :uint, :uint, :int, :pointer ].freeze,
    glPathSubCommandsNV: [ :void, :uint, :int, :int, :int, :pointer, :int, :uint, :pointer ].freeze,
    glPathSubCoordsNV: [ :void, :uint, :int, :int, :uint, :pointer ].freeze,
    glPathTexGenNV: [ :void, :uint, :uint, :int, :pointer ].freeze,
    glPointAlongPathNV: [ :uchar, :uint, :int, :int, :float, :pointer, :pointer, :pointer, :pointer ].freeze,
    glStencilFillPathInstancedNV: [ :void, :int, :uint, :pointer, :uint, :uint, :uint, :uint, :pointer ].freeze,
    glStencilFillPathNV: [ :void, :uint, :uint, :uint ].freeze,
    glStencilStrokePathInstancedNV: [ :void, :int, :uint, :pointer, :uint, :int, :uint, :uint, :pointer ].freeze,
    glStencilStrokePathNV: [ :void, :uint, :int, :uint ].freeze,
    glTransformPathNV: [ :void, :uint, :uint, :uint, :pointer ].freeze,
    glWeightPathsNV: [ :void, :uint, :int, :uint, :float ].freeze
  }.freeze
end
